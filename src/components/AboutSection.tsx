    ...
    <section id="sobre" className="py-24 bg-background">
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <p>
              Sou Tecnólogo em Gestão de Sistemas de Informação pela UNIP e Pós-graduado em Gestão de Tecnologia da Informação pela Faculdade Ideal (FACI). Também possuo formação técnica pelo SENAI/PA como Eletricista Industrial, Formação em Analista de Dados pela Comunidade DS.
            </p>
            <p>
